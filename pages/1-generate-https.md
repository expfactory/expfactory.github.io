...
If you added local experiments (see the [main generate page](https://expfactory.github.io/generate#local-experiment-selection) for instructions) we would see them as well:
